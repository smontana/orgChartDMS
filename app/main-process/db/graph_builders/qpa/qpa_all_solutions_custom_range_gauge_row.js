var qpa_solution_custom_range_avgs = {

  build_custom_range_solution_avgs_graphs: function (data) {
    ...
    var crm_chart = c3.generate({
      bindto: "#crm_qpa_custom_range_avg_gauge",
      data: {
        columns: [
    ...
    var cso_chart = c3.generate({
      bindto: "#cso_qpa_custom_range_avg_gauge",
      data: {
        columns: [
    ...
    var dms_chart = c3.generate({
      bindto: "#dms_qpa_custom_range_avg_gauge",
      data: {
        columns: [
    ...
    var fi_chart = c3.generate({
      bindto: "#fi_qpa_custom_range_avg_gauge",
      data: {
        columns: [
    ...
    var rts_chart = c3.generate({
      bindto: "#rts_qpa_custom_range_avg_gauge",
      data: {
        columns: [
...
module.exports = qpa_solution_custom_range_avgs;
